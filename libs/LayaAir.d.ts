...
declare module laya.d3.core.scene {
	...
	class BoundsOctreeNode {
		_children: Array<BoundsOctreeNode>;
		/**
...
declare module laya.device {
	class DeviceModel {
		static androidHairDevices;
		static androidOverallDevices;
	}
}
...
class Sprite_Example {
	...
	class Sprite extends laya.display.Node {
		...
		_style: laya.display.css.SpriteStyle;
		/**
		...
		_graphics: laya.display.Graphics;
		/**
		 ...
		 * @override 
		 */
		on(type: string, caller: any, listener: Function, args?: any[], index?: number): laya.events.EventDispatcher;
...
declare module laya.display {
	...
	class Stage extends laya.display.Sprite {
		...
		/** 适配的高度比例 designHeight * ratioY = cur */
		static adaptRatioY: number;
		/**刘海屏向下偏移像素*/
		static marginTop: number;
		/**是否是小程序*/
		static isWebChat: boolean;
		/**公共逻辑事件派发器（ts 层赋值） */
		logicDispatcher: any;
		/**
		*<p>获得每帧间隔平均值，单位为毫秒。</p>
...
function onInit()
{
	...
	class Text extends laya.display.Sprite {
		 ...
		 * 默认文本字体，默认为Arial
		 */
		static readonly defaultFont: string;

		/**设置字体  */
		static setFont(font: string, size?: number, fontOffsetY?: number): void;

		/**设置字体偏移值  */
		static setFontOffsetY(fontOffsetY: number): void;
...
declare module laya.events {
	...
	class EventDispatcher {
		 ...
		 * @return 此 EventDispatcher 对象。
		 */
		on(type: string, caller: any, listener: Function, args?: any[], index?: number): EventDispatcher;
		...
		createListener(type: string, caller: any, listener: Function, args: Array<any>, once: boolean, offBefore?: boolean, index?: number): EventDispatcher;
		/**
...
declare module laya.layaspine {
	...
	class SpineSkeletonRenderer {
		...
		draw(skeleton: Skeleton, slotRangeStart?: number, slotRangeEnd?: number, spineSkeletonIns?: SpineSkeleton, textureList?: Object): void;
	}
}
declare module laya.layaspine {
	class Renderable {
		...
		numVertices: number;
		numFloats: number;
		constructor(vertices: any, numVertices: number, numFloats: number);
	}
}
...
declare module laya.layaspine {
	...
	class SpineSkeleton extends Sprite {
		 ...
		 * @return templet
		 */
		readonly templet: SpineTemplet;
		/**当前动画名称或者索引*/
		readonly currAniName: any;
	}

	/**
	 * spine动画由<code>SpineTemplet</code>，<code>SpineSkeletonRender</code>，<code>SpineSkeleton</code>三部分组成。
	 */
	class SpineSkeletonEx extends SpineSkeleton {
		/** 已经添加的部件 key:url  */
		partDic: any
		constructor(templet?: SpineTempletEx);
		init(templet: SpineTempletEx): void;
		/**
		 * 获取已经穿上的部件数据
		 */
		getPartTemplet(skeUrl: string): SpineTempletEx;
		/**
		 * 修改添加部件
		 * @param {*} skeUrl 如果没加载则会自动加载
		 * @param complete param SpineTempletEx
		 * @return
		 */
		protected changePart(skeUrl: string, complete?: Laya.Handler): void;
		/**
		 * 移除部件
		 */
		clearPart(skeUrl: string, isUpdateCache?: boolean): void;
		/** 还原到基础模型 去掉动态添加的部件  */
		recoverBase(): void;
		/** 清理并回收到对象池  */
		recover(): void;
		/**
		 * 获取对象池里的SpineSkeletonEx
		 */
		static free(): SpineSkeletonEx;
	}
}
...
declare module laya.layaspine {
	 ...
	 * spine动画模板类
	 */
	class SpineTempletEx extends SpineTemplet {
		constructor();
		/**
		 * 通过皮肤名字得到皮肤索引
		 * @param	skelUrl url
		 ...
		 * @param	skelUrl url
		 */
		initSkelData(skelUrl: string): void;
		/**
		 * 克隆一个新的spineTemplet
		*/
		clone(): SpineTempletEx;
		/** 清理并回收到对象池  */
		recover(): void;
		/** 对象池中获取  */
		static free(): SpineTempletEx;
	}
}
...
declare module laya.layaspine {
	...
	class SkeletonMgr {
		 ...
		 * {url = SpineTempletEx} 
		 */
		static cachePartRes: any;
		/**
		 * 缓存模型的 集合
		 * {url = SpineTempletEx} 
		 */
		static cacheTemplet: any;
		/**
		 *  获取缓存中的temp
		 *  @param url url
		*/
		static getTemplet(url: string): SpineTempletEx;
		/**
		 * 检查更新是否需要释放的文件
		 */
		static updateReleaseRes(force?: boolean): void;
		/**
		 * 释放资源时间 默认5分钟 一般资源间隔是时间，超过这时间就释放资源
		 */
		static releaseTime: number;
		/**
		...
		*/
		static loadFunc: Function;
		/** 添加到释放白名单  */
		static addToReleaseWhite(url: string);
	}
}
declare module laya.layaspine {
	import Texture = laya.resource.Texture;
	import Texture2D = laya.resource.Texture2D;
	import TextureFilter = spine.TextureFilter;
	import TextureWrap = spine.TextureWrap;
	class SpineGLTexture extends Texture {
		constructor(tex: Texture2D, img: any);
		getImage(): any;
...
declare module laya.html.utils {
	...
	class HTMLParse {
		...
		public static imageUrls: any[];
		public static needImageCache: boolean;
...
declare module laya.net {
	...
	class Loader extends laya.events.EventDispatcher {
		...
		/**是否缓存加载（如果是不缓存模式，每次加载都强制刷新缓存，默认缓存）*/
		static cacheLoad: boolean;
		/**通用资源集合，此集合不会放入到group里*/
		static commonUrls: any[];

		/**
		 * 小程序检测资源可否缓存的方法function(url)
		 */
		static webchatCanCache: Function;
		/**
		 * 小程序下载资源接口function(url,callback)
		 */
		static webchatDownFile: Function;
		/**
		 * 小程序本地 缓存url function(url)
		 */
		static webchatNativeUrl: Function;
	}
...
declare module laya.net {
	...
	class LoaderManager extends laya.events.EventDispatcher {
		 ...
		 * 全局加载资源完成后的回调
		 */
		globalLoadedHandle: laya.utils.Handler;
		/**
		 * 获取模型资源的映射列表
		 */
		getLhMapUrls(url): Array<string>;
		/**
		 *清除模型的映射列表 
		 */
		clearLhMapUrls(url): void;
		/**
		 * 获取文件夹路径，传入的参数必须是包含完整路径，如：aa/bb/xx.png，获取的文件路径为：aa/bb/
		 * @param url
		 */
		getFolderPath(url): string;
		/**本地资源包后台动态待加载文件{url:ver} */
		dyLoadData: Object;
	}
	interface loadItem {
		url: string;
...
declare module laya.net {
	...
	class URL {
		 ...
		 * @return 	返回文件名。没有后缀
		 */
		static getFileName2(url: string): string;
		...
		/** app 背地包资源配置文件   {dirs:[],rootPath:string}*/
		static nativeConfig: any;

		/** app 背地包资源路径*/
		static nativePath: string;
	}
...
declare module laya.resource {
	...
	class Resource extends laya.events.EventDispatcher implements laya.resource.ICreateResource, laya.resource.IDestroy {
		...
		/**
		 * 是否强制释放无引用资源  1 加速部分释放 2 强制所有释放  默认0
		 * 没实现具体逻辑作状态记录处理供外部文件使用
		 */
		static forceRelease: number;

		/**
		 * forceRelease == 1 时 把 超过 forceCacheTime（默认 60*1000 ms）的无用资源
		 */
		static forceCacheTime: number;
...
declare module laya.ui {
	...
	class BaseView extends View {
		static closeHandle: Handler;
		static backHandle: Handler;
		static helpHandle: Handler;
		static clickHandle: Handler;
		/** 全面屏等适配时偏移值 用作关闭按钮偏移 */
		static adaptOffsetY: number;
		/**
		 * 窗口动作飘向器
		 */
		static GAction: any;
		...
		userData: any;
		protected _mediator: any;
		protected _popEffect: boolean;
		protected _popAction: Function;
		...
		destroy(destroyChild?: boolean): void;
		loadScene(path: string): void;
		refleshView(userData?: Object): void;
		resizeView(): void;
		protected onClick(event: Laya.Event): void;
		protected onPopEffectComplete(): void;
		protected onAdded(): void;
		protected onRemove(): void;
		protected offEvent(type: string, listener: Function): void;
		...
		protected playPopEffect(value: boolean): void;
		protected destroyComponent(target: Laya.Node[]): void;
		protected init(): void;
		protected onViewCreated(): void;
		public render(ctx: Laya.Context, x: number, y: number): void;
		bgClass(value: any): void;
		createBg(): void;
		removeBg(): void;
		readonly bgView: any;
		/**
...
declare module laya.ui {
	...
	class TitleList extends Panel {
		...
		refresh(): void;
		closeExpandTarget(): void
	}
}
declare module laya.ui {
	import View = laya.ui.BaseView;
	import Handler = laya.utils.Handler;
	/**
	 * <code>View</code> 是一个视图类，2.0开始，更改继承至Scene类，相对于Scene，增加相对布局功能。
	 */
	class BaseSceneView extends View {
		static closeSceneHandle: Handler;
		protected _rootLayer: Laya.Sprite;
		protected _bgLayer: Laya.Sprite;
		protected _elementLayer: Laya.Sprite;
		protected _bg: Laya.Sprite;
		protected _init: boolean;
		protected _pos: Laya.Point;

		initScene(): void;
		readonly bg: Laya.Sprite;
		readonly bgLayer: Laya.Sprite;
		readonly elementLayer: Laya.Sprite;
		readonly rootLayer: Laya.Sprite;
		addElementAt(value: Laya.Node, index: number): void;
		addElement(value: Laya.Node): void;
		removeElement(value: Laya.Node): void;
...
declare module laya.ui {
	 ...
	 * <code>View</code> 是一个视图类，2.0开始，更改继承至Scene类，相对于Scene，增加相对布局功能。
	 */
	class TitleListItem extends View {
		/** TitleList */
		constructor(list?: any, imgMinH?: number);
		// dataSource: any;
		/** TitleList */
		titleList: any;
		imgMaxH: number;
...
class Item extends Box {
	...
	class List extends laya.ui.Box implements laya.ui.IRender, laya.ui.IItem {
		...
		/**指定鼠标移动到单元时是否改变选择状态*/
		moveChangeState: boolean;

		/**selectEnable为true时，设置selectedIndex会判断重复就不处理，此属性控制selectedIndex必然会
		 * 处理，配合selectEnable使用
		 */
		selectForce: boolean;
		...
		/**
		 * @private 更改单元格的信息。在此销毁、创建单元格，并设置单元格的位置等属性。相当于此列表内容发送改变时调用此函数。
		 */
		...
		/**
		 * 列表组件渲染项如果超出了渲染范围，会默认将cell设置为不可见，但有时会有特殊需求需要，所以加了一个控制条件
		 * 将这个功能设为开关形式
		 * false：cell超出渲染范围不会设置不可见，依然还在舞台中
		 * true：默认隐藏
		*/
		cellVisible: boolean;
	}
...
declare module laya.ui {
	...
	class Panel extends laya.ui.Box {
		 ...
		 * @param e Event 对象。
		 */
		onScrollBarChange(scrollBar: laya.ui.ScrollBar): void;
		...
		/** 改变滚动内容的位置  */
		public changeScrollValue(value: number, scrollBar?: Laya.ScrollBar): void;
		/**
		 * 是否开启区域显示优化  true 可是区域才显示 默认为true
		 */
		isRectOptimize: boolean;
	}
...
class ProgressBar_Example {
	...
	class ProgressBar extends laya.ui.UIComponent {
		...
		*/
		...
		/**
		 * 设置进度条有颜色那个皮肤居中(自动居中 如何不需要自行设置y  下面那个函数setBarY)
		 */
		setAlign();
		...
		/**
		 * 获取进度条有颜色那条的正确（赋值后）宽度
		 */
		getBarDisplayWidth(): number;
		...
		/**显示方向 */
		dir: string;
		static DIR_LEFT: string;
		static DIR_RIGHT: string;
	}
...
declare module laya.ui {
	...
	class ScrollBar extends laya.ui.UIComponent {
		...
		/* 滚动点击事件是否使用舞台点击 default false */
		useStageClick: boolean;
...
declare module laya.ui {
	...
	class UIGroup extends laya.ui.Box implements laya.ui.IItem {
		 ...
		 */
		public setSelect(index: number, selected: boolean): void;
...
declare module laya.ui {
	...
	class UIUtils {
		...
		static clearFilterByType(target: laya.display.Sprite, filterType: number): void;

		static checkFilter(target: laya.display.Sprite, filterType: number): boolean;
		/**
		 * 获取当前要替换的转移字符
		 * @param word 
		 * @return 
...
declare module laya.utils {
	...
	class ClassUtils {
		...
		/**
		 * 重新设置类的名字 设置className 属性
		 * @param	cls 类的全名或者类的引用，全名比如:"laya.display.Sprite"。
		 * @param	className 映射的名字或者别名。
		 */
		static resetClassName(cls: any, className: string): void;

		/**
		 * 获取类的名字 优先获取 className 如果没则name 
		 * 可传入对象 或 类
		 */
		static getName(cls: any): string;

		/**获取类的全名 全名比如:"laya.display.Sprite"。*/
		static getPackName(cls: any): string;
...
declare module laya.utils {
	...
	class Tween {
		...
		static completeAll(target: any): void;
		/**
		 * 清理某个缓动。
		 * @param tween 缓动对象。
		 */
		...
		/**检查此对象是否有缓动*/
		static hasTarget(target: any): boolean;
...
declare module Laya {
	...
	class DeviceModel extends laya.device.DeviceModel { }
...
对HTML的显示对象进行排版
	...
	class Renderable extends laya.layaspine.Renderable {
	}

	class SpineSkeleton extends laya.layaspine.SpineSkeleton {
	}

	class SpineSkeletonEx extends laya.layaspine.SpineSkeletonEx {
	}

	class SpineTemplet extends laya.layaspine.SpineTemplet {
	}

	class SpineTempletEx extends laya.layaspine.SpineTempletEx {
	}

	class SkeletonMgr extends laya.layaspine.SkeletonMgr {
	}
...
class Item extends Box {
	...
	class BaseSceneView extends laya.ui.BaseSceneView {
	}

	class TitleListItem extends laya.ui.TitleListItem {
	}

	class TitleList extends laya.ui.TitleList {
	}
	class BaseItemRender extends laya.ui.BaseItemRender {
	}
